...
class GetTopPageHandler implements HandlerInterface
{
    ...
    public function run(): Response
    {
        ...
        $html = $this->compose->topPage(post_list: $post_list, post_tag_hash_map: $post_tag_hash_map, query: $query, csrf_token: CsrfManager::generate())->getHtml();

...
class PostHandler
{
    public static function getPostListPage(PageComposer $compose, PostClient $post_client): void
    {
    ...
    public static function createPost(PageComposer $compose, PostClient $post_client): void
    {
    ...
    public static function getPostDetailPage(int $post_id, PageComposer $compose, PostClient $post_client)
    {
    ...
    public static function getEditPage(int $post_id, PageComposer $compose, PostClient $post_client)
    {
        $post = $post_client->getPostById($post_id);
    ...
    public static function updatePost(int $post_id, PostClient $post_client): void
    {
    ...
    public static function deletePost(string $post_id, PostClient $post_client): void
    {
